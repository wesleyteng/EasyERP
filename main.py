...
# 引入路由模組
from api import ap_ar, inventory, transaction, orders, partners, accounts, JournalEntry
...
app.include_router(accounts.router, prefix="/api/accounts", tags=["Accounts (帳號權限管理)"])

app.include_router(JournalEntry.router, prefix="/api/journal-entries", tags=["Journal Entries"])
